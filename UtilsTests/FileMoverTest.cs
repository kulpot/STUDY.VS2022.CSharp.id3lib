...
#if VSNET // this whole test doesn't work in nunit 
          // because it was written to use TestContext.TestName
...
namespace TestProject
{
    ...
    public class FileMoverTest
    {
        ...
        public void NonNtfsReplaceTest()
        {
            ...
            FileMover_Accessor.NonNtfsReplace(sourceLocation, targetLocation, backupLocation);
